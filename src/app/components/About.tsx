  ...
  const skills = [
    {
      ...
      title: "Frontend",
      description: "React, Next.js, Vue, Motion, Handlebars",
    },
    {
      icon: <Server className="w-8 h-8 text-green-500" />,
      title: "Backend",
      description: "Node.js, Express, Fastify, Nest.js",
    },
    {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <p className="text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
              As a passionate Fullstack Developer, I specialize in building
              robust and scalable web applications. With a strong foundation in
              MySQL, Express.js, React, and Node.js—among other technologies—I
              develop integrated full-stack solutions that deliver exceptional
              user experiences.
            </p>
