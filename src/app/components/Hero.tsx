        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              ...
              Node.js. I work to create simple, strong, and scalable solutions,
              always focusing on performance and user experience. My goal is to
              deliver high-quality applications that meet project needs.
            </p>
